...
# 아래쪽 끝(E2=82Hz, G2=98Hz)을 반드시 포함한다: 탐색 하한을 넘어가면 진짜 피크가
# 범위 밖이 되고 2배음이 잡혀 "한 옥타브 위로" 오검출되며, 출력은 한 옥타브 낮게 나간다.
# 위쪽 끝의 대칭 문제(상한 초과 → 배주기 → 출력 한 옥타브 위)와 짝이다.
VOCAL_CENTRES = [40, 43, 45, 48, 52, 57, 64, 69, 72, 76]
